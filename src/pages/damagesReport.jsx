...
import DamageTable from "../components/damageTable.jsx";
...
function DamagesReport() {
  ...
  const fetchReports = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${API_URL}/report/damages`, {
        params: {
          limit,
          page,
        },
      ...
      setReports(response.data.damages);
      setTotalPages(response.data.totalPages);
      setTotalLogs(response.data.totalLogs);
      console.log("total logs:", response.data.totalLogs);
      console.log("total pages:", response.data.totalPages);
      console.log("Products fetched:", response.data.damages);
    } catch (error) {
    ...
    <div>
      <div className="flex justify-start">
        ...
        <div className="w-full p-4 bg-gray-300">
          ...
          <div className="p-2">
            <h3 className="text-2xl font-semibold mb-4">Damages List</h3>
