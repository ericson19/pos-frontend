...
export default function LowAlert() {
  ...
  const fetchProducts = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${API_URL}/report/low-stocks`, {
        withCredentials: true,
      });
      setProducts(response.data.lowStockProducts);
      console.log("Products fetched:", response.data.lowStockProducts);
    } catch (error) {
    ...
    <div>
      <div className="flex justify-start">
        ...
        <div className="w-full p-4 bg-gray-300">
          ...
          <div className="p-2">
            <h3 className="text-2xl font-semibold mb-4">Low Stock Alert</h3>
